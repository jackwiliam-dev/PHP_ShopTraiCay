                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    <h1><span>D</span>-Mobile</h1>
                                    <h2>Free E-Commerce Template</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                    <button type="button" class="btn btn-default get">Get it now</button>
                                </div>
                                <div class="col-sm-6">
                                    <img src="<?php echo e(('frontend/images/girl1.jpg')); ?>" class="girl img-responsive" alt="" />
                                    <img src="<?php echo e(('frontend/images/pricing.png')); ?>"  class="pricing" alt="" />
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <img src="<?php echo e(('frontend/images/girl2.jpg')); ?>" class="girl img-responsive" alt="" />
                                    <img src="<?php echo e(('frontend/images/pricing.png')); ?>"  class="pricing" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="<?php echo e(('frontend/images/girl3.jpg')); ?>" class="girl img-responsive" alt="" />
                                    <img src="<?php echo e(('frontend/images/pricing.png')); ?>" class="pricing" alt="" />
                                </div>
                            </div>
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                         <img src="<?php echo e(('frontend/images/iframe2.png')); ?>" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                         <img src="<?php echo e(('frontend/images/iframe3.png')); ?>" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                         <img src="<?php echo e(('frontend/images/iframe4.png')); ?>" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\StoreSmartPhone\resources\views/Banhang/master.blade.php ENDPATH**/ ?>