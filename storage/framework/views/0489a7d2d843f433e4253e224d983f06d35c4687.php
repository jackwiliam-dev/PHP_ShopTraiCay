                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="index.html"><img src="<?php echo e(('frontend/images/home/logo1.png')); ?>" alt="" /></a>
                        </div>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    <h1><span>Summer</span>Fruit</h1>
                                    <h2>100% Pure Natural Fruit Juice</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                    <button type="button" class="btn btn-default get">Get it now</button>
                                </div>
                                <div class="col-sm-6">
                                    <img src="<?php echo e(('frontend/images/banner-1.jpg')); ?>" class="girl img-responsive" alt="" />
                                    
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span>Dried &</span>Drink Fruits</h1>
                                    <h2>With 25% Off All Teas</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                    <button type="button" class="btn btn-default get">Get it now</button>
                                </div>
                                <div class="col-sm-6">
                                    <img src="<?php echo e(('frontend/images/banner-2.jpg')); ?>" class="girl img-responsive" alt="" />
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="<?php echo e(('frontend/images/blog-1.jpg')); ?>" class="girl img-responsive" alt="" />
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="<?php echo e(URL::to('/thuong-hieu-san-pham/'.$brand->brand_id)); ?>"> <span class="pull-right">(50)</span><?php echo e($brand->brand_name); ?></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                        </div><!--/brands_products-->
                    ...
                    <div class="col-sm-7">
                            ...
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="<?php echo e(('frontend/images/iframe1.jpg')); ?>" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                         <img src="<?php echo e(('frontend/images/iframe2.jpg')); ?>" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                         <img src="<?php echo e(('frontend/images/iframe3.jpg')); ?>" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                         <img src="<?php echo e(('frontend/images/iframe4.jpg')); ?>" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">18DTH2A</a></span></p>
                </div>
            </div>
        </div>
...
</html><?php /**PATH D:\New folder (2)\StoreSmartPhone\resources\views/Banhang/master.blade.php ENDPATH**/ ?>