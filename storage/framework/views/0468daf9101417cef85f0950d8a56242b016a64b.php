                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="5" class="form-control" name="category_product_desc" id="exampleInputPassword1"><?php echo e($edit_value->category_desc); ?></textarea>
                                </div>
...
<?php echo $__env->make('Banhang.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StoreSmartPhone\resources\views/admin/edit_category_product.blade.php ENDPATH**/ ?>